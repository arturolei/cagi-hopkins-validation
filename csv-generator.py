...
for item in range(106):
    temp_dict = {'patient': 'P'+str(item+1), ' 1-P': '*', '1-SD': '*', '1-V': '*', ' 2-P': '*', '2-SD': '*', '2-V': '*', ' 3-P': '*', '3-SD': '*', '3-V': '*', '4-P': '*', '4-SD': '*', '4-V': '*', '5-P': '*', '5-SD': '*', '5-V': '*', '6-P': '*', '6-SD': '*', '6-V': '*', '7-P': '*', '7-SD': '*', '7-V': '*', '8-P': '*', ' 8-SD': '*', ' 8-V': '*', ' 9-P': '*', ' 9-SD': '*', ' 9-V': '*', ' 10-P': '*', '10-SD': '*', '10-V': '*', '11-P': '*', '11-SD': '*', ' 11-V': '*', ' 12-P': '*', '12-SD': '*', ' 12-V': '*', '13-P': '*', '13-SD': '*', '13-V': '*', ' 14-P': '*', '14-SD': '*', ' 14-V': '*', 'C': '*'}
...
with open ('5-Hopkins_clinical_panel_submission_template2.csv','w', newline='') as my_new_file:
